...
QT_MOC_LITERAL(1, 7, 9), // "mouse_pos"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 11) // "mouse_press"

    },
    "mlabel\0mouse_pos\0\0mouse_press"
};
...
void mlabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mouse_press(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (mlabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mlabel::mouse_pos)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (mlabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mlabel::mouse_press)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void mlabel::mouse_pos()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void mlabel::mouse_press()
{
